...
import com.example.tap2024.HelloApplication;
...
public class Calculadora extends Stage {
    ...
    public Calculadora(HelloApplication helloApplication) {
        Crear_UI();
        ...
        if (Simbolo == '-') {
            ...
            if (Contenido_en_pantalla.isEmpty()) {
                if ("+-*/".indexOf(Simbolo) >= 0) {
                    ...
                    TF_Cuadro_Texto.setText("Syntax Error");
                }
            } else {
                Primer_numero = Double.parseDouble(Contenido_en_pantalla);
                Operador = Simbolo + "";
            ...
            Calcular();
            TF_Cuadro_Texto.setText(TF_Cuadro_Texto.getText().equals("Syntax Error") ? "Syntax Error" : String.valueOf(Resultado));
            Contenido_en_pantalla = "";
            Operador = "";
            Tiene_decimal = false;
    ...
    private void Calcular() {
        if ("Syntax Error".equals(TF_Cuadro_Texto.getText())) {
            return;
        }
